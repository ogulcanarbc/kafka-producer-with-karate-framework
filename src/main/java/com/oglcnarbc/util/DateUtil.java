...
public class DateUtil {
    ...
    public static String getYesterdayEpochMiliSecAsString() {
        return String.valueOf(Instant.now().toEpochMilli() - 86400000L);
    }

    public static Long getTodayEpochMiliSec() {
        return Instant.now().toEpochMilli();
    }

    public static Long getYesterdayEpochMiliSec() {
